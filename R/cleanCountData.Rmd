...
But I don't have a lot of time, at least it is reproducible. 
...
I need to loop over names(countData.2), grep sampleNames[,1], returns row #, and replace with corresponding sampleNames[row,2]. 
...
Now I am ready for RNAseq and GO enrichment. Talk with Neelima and Brad about the samples and the work that needs to be done. 
