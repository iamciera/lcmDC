...
Cluster visualization functions. These are functions that are re-used throughout analysis. These are not printed out in reports to save space. See .Rmd file for specifics of these funtions.
...
Also, varying SOM sizes could yield more explicit gene expression patterns if larger SOM or allow the ability to do GO-enrichment/promoter enrichment if smaller SOM. 
